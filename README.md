...
Prieš paleidžiant projektą, privalote turėti:

- **Node.js** (versija 18 arba naujesnė) - JavaScript runtime
- **npm** (pasitaiko su Node.js) - paketų valdiklis

Jei jų neturite, atsisiųskite iš [nodejs.org](https://nodejs.org/)

## Kodo paleidimas

1. Iš pradžių nueikite prie aplanko my-app:
```bash
cd my-app
```

2. Projekto priklausomybėms paleiskite šitą komandą:
```bash
npm install
```

3. Projekto surinkimas:
```bash
npm run build
```
